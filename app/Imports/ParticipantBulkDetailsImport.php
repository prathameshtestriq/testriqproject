            ...
            if(!empty($AllTickets)){
                foreach($AllTickets as $res){
                   ...
                   // dd($Convenience_Fee_Amount,$GST_On_Convenience_Fees);
                    ...
                    $res->Main_Price  = $res->ticket_price;
                    $res->OrgPayment  = '0.00';
                    $res->YtcrAmount  = ($res->ticket_price * ($res->YTCR_FEE_PERCENT /100));
                    $res->Extra_Amount  = $additional_amount;
                    $res->Total_Taxes   = $totalTaxes;
                    ...
                    $res->Total_Platform_Fee  = $totalPlatformFee;
                    ...
                    $res->Registration_Fee_GST  = $BasePriceGst;
                    ...
                    $res->Payment_Gateway_Charges  = $Payment_Gateway_Buyer;
