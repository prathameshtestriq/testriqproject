...
class SmsApis{
	...
	public function post_sms($mobile,$otp)
	{
		if(!empty($otp)&& !empty($mobile)){
			...
			$url = "http://site.ping4sms.com/api/smsapi?key=aebaa88ce79128bcb31282dcdb6507d5&route=2&sender=YTCRUN&number=$mobile&sms=Dear%20Customer,%20Your%20Login%20OTP%20for%20the%20$otp%20Thank%20you%20-%20YOUTOOCANRUN&templateid=1707170556227384012";
