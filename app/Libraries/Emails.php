...
class Emails{
	...
	public function post_email($athelete_email,$otp)
	{
		...
		$email->addContent(
			"text/html", "Dear Customer, Your OTP is: <strong>".$otp."</strong><p>Thank you,<br>YTCRUN</p>"
		);
    ...
    public function post_email_pwd($athelete_email,$password)
	{
		...
		$email->addContent(
			"text/html", "Dear Customer, Your password is: <strong>".$password."</strong><p>Thank you,<br>YTCRUN</p>"
		);
    ...
    public function send_reset_password_link($athelete_email,$reset_link)
	{
		...
		$email->addContent(
			"text/html", "You have requested to reset your password. Please click the link below to reset your password.<br>".$reset_link."<br><p>Thank you,<br>YTCRUN</p>"
		);
