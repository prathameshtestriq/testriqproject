        ...
        <div class="row match-height pt-2">
         ...
         <div class="row pr-2">
            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
               <div class="row ">
                  <div class="card-body" style="padding: 0.5rem 0.5rem">
                      <!-- Registrations Successful && Participants -->
                     <div class="row justify-content-between mx-1 m-2">
                        <div class="" style="min-width: 390px;">  
                     ...
                     <!-- Total Registrations && Total Events -->
                     <div class="row justify-content-between mx-1 m-2">
                        <div class="" style="min-width:390px;">  
                           <!-- Total Registrations  -->
                           <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                              ...
                              <div class="card card-equal-height m-0 custom-highlight-bg">
                                 <div class="card-body ">
                                    ...
                                    <div class="row mb-0">
                                          ...
                                          <div class="col-sm-6">
                                             <div class="d-flex align-items-center justify-content-center">
                                                <img src="{{ asset('uploads/dashboard/live_event.png') }}" alt="avatar" height="100" width="100">
                                             </div>
                                          </div>
                                    </div>
                                    {{-- <div class="dashboard-card-min canvas1 mt-1" id=""></div> --}}
                        ...
                        <div class="card-body">
                          <div class="row">
                           ...
                           <p class="highcharts-description">
                              <h5 class="text-primary  pull-left ">Category Wise Bar Chart Data</h5> 
                           </p>

                           <figure class="highcharts-figure">
                              <div class="highcharts-data-table"><br/>
                                 <caption class="text-center">Category Booking Data</caption>
                                  <table>
