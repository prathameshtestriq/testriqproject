...
@section('title', 'Rest Category List')
                    ...
                    <div class="card-header w-100">
                        <div class="content-header-left">
                            <div class="row breadcrumbs-top">
                                <div class="col-sm-12">
                                    <h2 class="content-header-title float-left mb-0">Rest Category List</h2>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-end breadcrumb-wrapper">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mr-1">
                                    ...
                                    <li class="breadcrumb-item">Rest Category</li>
                                    <li class="breadcrumb-item active" aria-current="page">Rest Category List</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-header w-100 m-0">
                                <div class="row w-100">
                                    <div class="col-sm-8">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <label for="form-control"> Rest Category Name:</label>
                                                <input type="text" id="name" class="form-control"
                                                    placeholder="Rest Category Name" name="name" value="{{ $search_name }}"
                                                    autocomplete="off" />
                                            </div>
                                    ...
                                    <div class="col-sm-4 mt-2">
                                        <a href="{{ url('/type/add') }}" class="btn btn-outline-primary float-right">
                                            <i data-feather="plus"></i><span>Add Rest Category</span></a>
                                    </div>
                                </div>
                            </div>
                        </form>
