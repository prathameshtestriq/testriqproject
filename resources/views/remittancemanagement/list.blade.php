...
@section('title', 'Remittance Management List')
                        ...
                        <div class="card-header w-100">
                            <div class="content-header-left">
                                <div class="row breadcrumbs-top">
                                    <div class="col-sm-12">
                                        <h2 class="content-header-title float-left mb-0">Remittance Management List</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end breadcrumb-wrapper">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb mr-1">
                                        ...
                                        <li class="breadcrumb-item">Remittance Management</li>
                                        <li class="breadcrumb-item active" aria-current="page">Remittance Management List</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                ...
                                <div class="row w-100">
                                    ...
                                    <div class="col-sm-4 mt-2">
                                        <a href="{{ url('remittance_management/add') }}"
                                            ...
                                            <i data-feather="plus"></i><span>Add Remittance Management </span></a>
                                    </div>
                                </div>
                            </div>
                        </form>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $val->gross_amount }}</td>
                                            <td class="text-center">{{ $val->service_charge }}</td>
                                            <td class="text-center">{{ $val->Sgst }}</td>
                                            <td class="text-center">{{ $val->Cgst }}</td>
                                            <td class="text-center">{{ $val->Igst }}</td>
                                            <td class="text-center">{{ $val->deductions }}</td>
                                            <td class="text-center">{{ $val->Tds }}</td>
                                            <td class="text-center">{{ $val->amount_remitted }}</td>
