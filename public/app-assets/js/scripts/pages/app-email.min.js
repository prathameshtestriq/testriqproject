...
$((function() {
    ...
    var t = $(".compose-email"),
        ...
        B = "app-assets/";
    if ("laravel" === $("body").attr("data-framework") && (B = $("body").attr("data-asset-path")), v.length && v.toggle(), f && f.toggle(), g.length && g.on("click", (function() { v.toggle() })), u.length && u.on("click", (function() { f.toggle() })), $.app.menu.is_touch_device()) $(i).css("overflow", "scroll"), $(c).css("overflow", "scroll"), $(d).css("overflow", "scroll");
