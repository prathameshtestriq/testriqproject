...
! function(t, e) {
    ...
    return function() {
        function e(e, n) {
            var s = this;
            var manual_current_index = localStorage.getItem('manual_current_index') ? localStorage.getItem('manual_current_index') : 1;
            void 0 === n && (n = {}), this._element = e, this._currentIndex = manual_current_index, this._stepsContents = [], this.options = t({}, h, {}, n), this.options.selectors = t({}, h.selectors, {}, this.options.selectors), this.options.linear && this._element.classList.add(r.LINEAR), this._steps = [].slice.call(this._element.querySelectorAll(this.options.selectors.steps)), this._steps.filter(function(t) {
