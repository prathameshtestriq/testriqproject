$((function() {
    ...
    if ($("#shape-map").length) {
        var r = L.map("shape-map").setView([51.5, -.09], 12);
    ...
    if ($("#user-location").length) {
        ...
        i.locate({ setView: !0, maxZoom: 16 }), i.on("locationfound", (function(e) {
            var t = e.accuracy;
            L.marker(e.latlng).addTo(i).bindPopup("You are somewhere around " + t + " meters from this point").openPopup(), L.circle(e.latlng, t).addTo(i)
    ...
    if ($("#custom-icons").length) {
        var n = L.map("custom-icons").setView([51.5, -.09], 10),
        ...
        L.marker([51.5, -.09], { icon: y }).addTo(n), L.marker([51.4, -.51], { icon: p }).addTo(n), L.marker([51.49, -.45], { icon: s }).addTo(n), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(n)
    }
    if ($("#geojson").length) {
        var d = L.map("geojson").setView([44.2669, -72.576], 3);
        L.geoJson(t).addTo(d), L.geoJson(t, { style: function(e) { return { fillColor: (t = e.properties.density, t > 1e3 ? "#800026" : t > 500 ? "#BD0026" : t > 200 ? "#E31A1C" : t > 100 ? "#FC4E2A" : t > 50 ? "#FD8D3C" : t > 20 ? "#FEB24C" : t > 10 ? "#FED976" : "#FFEDA0"), weight: 2, opacity: 1, color: "white", dashArray: "3", fillOpacity: .7 }; var t } }).addTo(d), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(d)
    }
